...
class ChatBox(gtk.ScrolledWindow):
    ...
    def add_text(self, buddy, text, status_message=False):
        ...
        self._conversation.show_all()		"""Here message.add_text(text) adding text in entry box add it to chatbox 
								now we need to clear this chatbox on certain event"""
    
    """def make_empty(self):
    	self._conversation.hide_all()	this function can only hide previus conversation in chatbox but as we add new text it appears back as it is with appended text""" 
